...
dist_wide_retention_2015 <- (sum( Merge_2014_2015$retained_in_district == 1, na.rm = TRUE))/(sum(Merge_2014_2015$include_in_dist_calc == 1, na.rm = TRUE))
...
dist_wide_retention_2012 <- data.frame(aggregate(cbind(Merge_2011_2012$retained_in_district, Merge_2011_2012$include_in_dist_calc) ~  grade_level_2011, Merge_2011_2012,sum))
dist_wide_retention_2011 <- data.frame(aggregate(cbind(Merge_2010_2011$retained_in_district, Merge_2010_2011$include_in_dist_calc) ~  grade_level_2010, Merge_2010_2011,sum))
dist_wide_retention_2010 <- data.frame(aggregate(cbind(Merge_2009_2010$retained_in_district, Merge_2009_2010$include_in_dist_calc) ~  grade_level_2009, Merge_2009_2010,sum))
dist_wide_retention_2009 <- data.frame(aggregate(cbind(Merge_2008_2009$retained_in_district, Merge_2008_2009$include_in_dist_calc) ~  grade_level_2008, Merge_2008_2009,sum))
dist_wide_retention_2008 <- data.frame(aggregate(cbind(Merge_2007_2008$retained_in_district, Merge_2007_2008$include_in_dist_calc) ~  grade_level_2007, Merge_2007_2008,sum))
dist_wide_retention_2007 <- data.frame(aggregate(cbind(Merge_2006_2007$retained_in_district, Merge_2006_2007$include_in_dist_calc) ~  grade_level_2006, Merge_2006_2007,sum))
dist_wide_retention_2006 <- data.frame(aggregate(cbind(Merge_2005_2006$retained_in_district, Merge_2005_2006$include_in_dist_calc) ~  grade_level_2005, Merge_2005_2006,sum))
dist_wide_retention_2005 <- data.frame(aggregate(cbind(Merge_2004_2005$retained_in_district, Merge_2004_2005$include_in_dist_calc) ~  grade_level_2004, Merge_2004_2005,sum))
dist_wide_retention_2004 <- data.frame(aggregate(cbind(Merge_2003_2004$retained_in_district, Merge_2003_2004$include_in_dist_calc) ~  grade_level_2003, Merge_2003_2004,sum))
dist_wide_retention_2003 <- data.frame(aggregate(cbind(Merge_2002_2003$retained_in_district, Merge_2002_2003$include_in_dist_calc) ~  grade_level_2002, Merge_2002_2003,sum))
...
sch_wide_retention_all <- sch_wide_retention_all[c(1,42,2:41)]
